import sys
from example_bots.python import odds_bot, random_bot, never_bluff_bot, chicken_bot, bluff_bot
from test import run_benchmark, run_table
import my_bot
import javabot.java_wrapper as java_wrapper
bots = [odds_bot, random_bot, never_bluff_bot, chicken_bot, bluff_bot]
